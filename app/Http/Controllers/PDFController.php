...
{
    public function reporte($id1,$id2,$id3,$id4,$id5,$monto_apuesta)
    {
        $equipos=array();
        ...
        for($h=0;$h<3;$h++)
        {
            ...
            $titulo = '<h1>COMBINACIONES APOCALIPSIS (Apuesta:'.$monto_apuesta.'$)</h1>';//titulo de la planilla en formato pdf
            ...
            for($p=0;$p<3;$p++)
            {
                ...
                for($u=0;$u<$longitud;$u++)
                {
                    ...
                    $ap_ticket=PDFM::apuesta_ticket_apocalipsis($cont,$monto_apuesta);
                    

                    $cuota_ticket=round(PDFM::logro_combinado_apocalipsis($apt1,$apt2,$equipos),2);
        ...
        PDF::Output('Combinaciones_Apocalipsis.pdf','I');
    }
